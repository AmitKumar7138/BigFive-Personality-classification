...
class RoBERTaLargePersonalityTrainer:
    def __init__(self, dataframe, model_name='roberta-large', output_dir='RoBerta_Large', num_labels=5, epochs=3, lr=2e-5, batch_size=16):
    ...
    def train_and_evaluate(self):
        ...
        df_vals.to_csv(
            f'RoBERTa_Large_output{self.batch_size}{self.lr}{self.epochs}.csv', index=False)
