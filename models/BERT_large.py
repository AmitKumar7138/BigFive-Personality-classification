...
class BERTLargePersonalityTrainer:
    def __init__(self, dataframe, model_name='bert-large-uncased', output_dir='Bert_Large', num_labels=5, epochs=3, lr=2e-5, batch_size=16):
    ...
    def train_and_evaluate(self):
        ...
        df_vals.to_csv(
            f'BERT_Large_output{self.batch_size}{self.lr}{self.epochs}.csv', index=False)
